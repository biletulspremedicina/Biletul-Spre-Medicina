/*
# Corectare ambiguitate coloane în start_exam_attempt și submit_exam_attempt

Problema: În funcțiile PL/pgSQL cu RETURNS TABLE care au coloane numite
`id`, `user_id`, `simulation_id` etc., referințele necalificate în
UPDATE/WHERE/RETURNING sunt ambigue — PostgreSQL nu știe dacă se referă
la coloana tabelului sau la parametrul de ieșire al funcției.

Soluție: Se califică TOATE referințele cu aliasul tabelului (att.id, att.user_id etc.)
*/

-- ============================================================
-- start_exam_attempt — calificat complet
-- ============================================================
...
BEGIN
  ...
  IF v_sim.requires_subscription = true THEN
    ...
    INSERT INTO public.attempts AS att (user_id, simulation_id, answers, score, max_score, started_at)
...
-- ============================================================
-- submit_exam_attempt — calificat complet
-- ============================================================
