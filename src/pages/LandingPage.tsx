...
function TicketCard({ onGetStarted }: { onGetStarted: () => void }) {
  ...
  <path 
d="M0 25 H18 L23 20 L28 25 H41 L45 30 L50 3 L55 39 L60 25 H67 L74 14 L83 25 H138 L143 20 L148 25 H161 L165 30 L170 3 L175 39 L180 25 H187 L194 14 L203 25 H258 L263 20 L268 25 H281 L285 30 L290 3 L295 39 L300 25"
    fill="none" 
    stroke="currentColor" 
    strokeOpacity={0.15} 
    strokeWidth="1.5" 
